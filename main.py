...
def train_with_mlflow():
    ...
    # Set MLflow tracking URI to local directory (absolute path)
    import os
    ...
    with mlflow.start_run() as run:
        ...
        # Create input example for model signature inference
        input_example = X_test.head(1)
        mlflow.sklearn.log_model(trainer.pipeline, name="model", input_example=input_example)
